...
class Agent(ABC):
    ...
    @bundle(trainable=False, unpack_input=True, allow_external_dependencies=True)
    def think(self):
        """
        This function calls the OpenAI API to produce a response from an LLM like GPT-4.
        """
